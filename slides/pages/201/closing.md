...
- 103 → 201: validation and distrust taught you that AI output is unreliable without governance.
  Instructions are the governance layer that shifts from reactive validation to proactive standards.
- 201 → 202: instructions govern individual interactions. Module 202 introduces agents and skills —
