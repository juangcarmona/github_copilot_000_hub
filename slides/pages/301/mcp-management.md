...
<div class="flex justify-center mt-4">
  <img src="/301/mcp-list-servers.png" class="w-full object-contain rounded shadow max-h-72" />
</div>
...
Servers can fail, need restarting, or produce errors.
The MCP output log is where you debug server issues.
-->
