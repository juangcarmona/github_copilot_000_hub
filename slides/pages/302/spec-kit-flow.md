...
Constitution → Specify → Plan → Tasks → Implement. Each step builds on the previous one. The spec is the north star.
...
- You can't break into tasks without an architectural approach (plan first)
- You can't implement without scoped units (tasks first)

Each step reduces ambiguity further. By the time you implement, the solution space is narrow enough for predictable AI output.
-->
