...
Browser automation and testing. Run E2E tests, capture screenshots, validate UI changes.
...
<div class="mt-3 text-sm opacity-70">Each server is presented by its workflow use case, not its feature list.</div>
