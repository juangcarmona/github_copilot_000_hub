...
The Fibonacci example is simple enough that attendees can focus on the PROCESS
rather than the problem domain.

The first prompt is intentionally basic: "create a function to calculate Fibonacci numbers."
The response works, but doesn't match our preferences yet.
-->
