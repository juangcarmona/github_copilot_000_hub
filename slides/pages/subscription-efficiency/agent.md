...
Used badly, it burns PRUs — each internal step is a separate model invocation.
Used well, it turns one premium interaction into a large amount of implemented work.

From our Copilot Usage Guidelines (handbook.plainconcepts.com):
...
- handbook.plainconcepts.com → GitHub Copilot Usage Guidelines and Best Practices
-->